...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex justify-content-between align-items-center">
            <div class="logo d-flex align-items-center">
                <h1><a href="index.html" class="align-items-center1" style="color: #7d2a09;">Dayno Kopi</a></h1>
            </div>
    ...
    <div class="container">
    <div class="row justify-content-center text-center align-items-center" style="min-height: 70vh;">
        <div class="col-lg-8">
            <h1 data-aos="fade-down">
                Selamat Datang di <span class="text-brown">Dayno Kopi</span>
            </h1>
            <p class="mb-5" data-aos="fade-up" data-aos-delay="800">
                Nikmati aroma dan rasa kopi terbaik dari biji pilihan. Tempat nongkrong, kerja, dan rehat terbaik untuk Anda.
            </p>
            <a href="{{ route('login') }}" class="btn btn-outline-white btn-lg" data-aos="zoom-in" data-aos-delay="800">
                Login
            </a>
        </div>
    </div>
